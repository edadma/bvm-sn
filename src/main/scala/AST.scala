...
case class EveryExpressionAST( label: Option[String], gen: ExpressionAST, body: Option[ExpressionAST], els: Option[ExpressionAST] ) extends ExpressionAST
...
case class ForLoopExpressionAST( label: Option[String], gen: GeneratorExpressionAST, body: Option[ExpressionAST], els: Option[ExpressionAST] ) extends ExpressionAST
case class ForExpressionAST( label: Option[String], gen: List[GeneratorExpressionAST], body: ExpressionAST, els: Option[ExpressionAST] ) extends ExpressionAST
